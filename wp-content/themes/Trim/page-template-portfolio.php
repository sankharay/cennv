						...
						<div class="et_pt_portfolio_item">
							...
							<div class="et_pt_portfolio_entry<?php if ( $height == $et_portrait_height ) echo ' et_portrait_layout'; ?>">
								<div class="et_pt_portfolio_image<?php if ( $et_has_video ) echo ' et_video'; ?>">
									...
									<a class="et_portfolio_zoom_icon fancybox<?php if ( $et_has_video ) { echo ' mfp-iframe'; } else { echo ' mfp-image'; } ?>" title="<?php the_title_attribute(); ?>"<?php if ( ! $et_has_video ) echo ' rel="portfolio"'; ?> href="<?php if ( $et_has_video ) echo esc_url( '#' . $et_video_id ); else echo($thumbnail['fullpath']); ?>"><?php esc_html_e('Zoom in','Trim'); ?></a>
